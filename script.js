document.addEventListener('DOMContentLoaded', function () {
  ...
  (function applyRTLSupport() {
    ...
    if (isRTL) {
      ...
      style.setAttribute('data-rtl-scroll-fix', 'true');
      style.textContent = [
        '.fade-in-hidden { opacity: 0; transform: translateY(20px); transition: opacity 0.6s ease, transform 0.6s ease; }',
        '.fade-in-visible { opacity: 1; transform: translateY(0); }'
      ].join('\n');
      document.head.appendChild(style);
    } else {
      const style = document.createElement('style');
      style.setAttribute('data-scroll-animations', 'true');
      style.textContent = [
        '.fade-in-hidden { opacity: 0; transform: translateY(20px); transition: opacity 0.6s ease, transform 0.6s ease; }',
        '.fade-in-visible { opacity: 1; transform: translateY(0); }'
      ].join('\n');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '040482cd-c199-4911-928c-3a4d059e1267',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '040482cd-c199-4911-928c-3a4d059e1267';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '040482cd-c199-4911-928c-3a4d059e1267';
